...
local function createSetting(i)
    ...
    return { type = "box", flexFlow = lvgl.FLOW_ROW, children = {
            ...
            { type = "font", get = (function() return settings.sliders[i].font; end),
                            set = (function(v) settings.sliders[i].font = v; end), w = 2 * w / 3 },                                     
            ...
            {type = "numberEdit", min = 1 , max = 16, w = w / 2, 
...
local function createButtonSetting(i)
    ...
    return { type = "box", flexFlow = lvgl.FLOW_ROW, children = {
            {type = "label", text = "Name: "},
            {type = "textEdit", value = settings.buttons[i].name, set = (function(v) settings.buttons[i].name = v; end), w = w},
            {type = "label", text = " Type:" },
            {type = "choice", title = "Type", values = {"Button", "Toggle", "Momentary"}, w = w, 
            ...
            { type = "font", get = (function() return settings.buttons[i].font; end),
                            set = (function(v) settings.buttons[i].font = v; end), w = 2 * w / 3 },                                     
            {type = "label", text = "VS: "},
            {type = "numberEdit", min = 1 , max = 64, w = w / 2, 
