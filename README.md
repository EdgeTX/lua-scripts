...
For color screen radios, use [rotorman's fork](https://github.com/rotorman/FrskyTelemetryScript/tree/dev/HORUS/SOURCES/SRC) instead, which has EdgeTX color fixes, and support for [OlliW MavSDK](http://www.olliw.eu/2020/olliwtelem/) ([EdgeTX PR #150](https://github.com/EdgeTX/edgetx/pull/150))<br/>
...
## [Yaapu Horus Mapping Widget for iNAV/Betaflight](https://github.com/yaapu/HorusMappingWidget) - Offline GPS Mapping Widget for Horus and T16 radios
...
## [GPS widget](https://github.com/moschotto/OpenTX_GPS_Telemetry) - GPS Telemetry Widget (B&W & Color)
...
## [Multi Protocol Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/tree/master/Lua_scripts) - Scripts that support the MPM
...
## [Betaflight LUA Script](https://github.com/betaflight/betaflight-tx-lua-scripts) - Configure Betaflight from your radio
Betaflight LUA script allows you to change flight controller settings on your radio, such as PID, rates, VTX channels and power, and many more.<br/>
<img src="https://oscarliang.com/ctt/uploads/2021/07/betaflight-lua-script-config-home-menu-screen-options.jpg" width="250"></a>

## [INAV Lua Telemetry Flight Status](https://github.com/iNavFlight/OpenTX-Telemetry-Widget) - Show you telementry and flight status information.
Supports radios with color and black and white screens.<br/>
...
## [FM2M ToolBox](http://fm2m.jimb40.com/ToolBox.html) - A feature rich toolbox that provides a dashboard, telemetry info, alerts and much more.<br/>
...
## [TBS Agent Lite](https://www.team-blacksheep.com/products/prod:agentx) - LUA configurator for numerous TBS products
Use instead of Crossfire lua.<br/>
